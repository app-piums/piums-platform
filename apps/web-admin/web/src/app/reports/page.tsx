    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-zinc-900">
        ...
        <div className="mt-3 rounded-lg bg-zinc-50 p-3 text-sm dark:bg-zinc-800">
          <p className="font-medium text-zinc-700 dark:text-zinc-300">{report.motivo}</p>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`rounded-full px-2.5 py-0.5 text-xs font-medium capitalize ${ESTADO_REPORTE_STYLES[r.estado] ?? ESTADO_REPORTE_STYLES.pending}`}>
                      {r.estado}
                    </span>
                  ...
                  <p className="mt-2 text-sm font-medium text-zinc-900 dark:text-zinc-50">{r.motivo}</p>
                  <p className="mt-1 text-sm text-zinc-500 line-clamp-2">{r.descripcion}</p>
                  <p className="mt-2 text-xs text-zinc-400">
