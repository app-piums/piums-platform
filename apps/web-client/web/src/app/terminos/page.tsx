        ...
        <div className="space-y-8 text-gray-700">
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@piums.io" className="text-[#FF6A00] hover:underline">legal@piums.io</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@piums.io" className="text-[#FF6A00] hover:underline">legal@piums.io</a>{' '}
              o visita{' '}
              <a href="/contacto" className="text-[#FF6A00] hover:underline">nuestro formulario de contacto</a>.
            </p>
          </section>
