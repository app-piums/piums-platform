            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 rounded-xl border border-[#1877F2]/50 bg-[#1877F2]/80 hover:bg-[#1877F2] px-3 py-2.5 text-xs font-semibold text-white focus:outline-none transition-all"
                >
