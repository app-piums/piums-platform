      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <h3 className="text-white font-semibold text-sm mb-1">Descarga la app Piums Cliente</h3>
              <p className="text-xs text-gray-400">Gestiona tus reservas desde donde estés. Disponible para iOS y Android.</p>
            </div>
            <div className="flex items-center gap-3 shrink-0">
              <a
                ...
                className="flex items-center gap-2.5 px-4 py-2.5 bg-white/10 hover:bg-white/15 border border-white/10 rounded-xl transition-colors group"
              >
