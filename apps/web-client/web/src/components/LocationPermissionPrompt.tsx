      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Artistas cerca de ti</p>
          </div>
        </div>

        <p className="text-sm text-gray-600 mb-5 leading-relaxed">
          Usa tu ubicación para ver artistas disponibles en tu país y pre-rellenar tu filtro de búsqueda automáticamente.
        </p>
            ...
            [
              {
                ...
                label: 'Solo una vez',
                desc: 'Detectar ahora sin guardar preferencia',
              },
              {
                mode: 'while_in_use' as GeoMode,
                label: 'Mientras uso la app',
                desc: 'Activo mientras tengas Piums abierto',
                recommended: true,
              },
              {
