...
const TIPOS = [
  { value: 'QUALITY',       label: 'Calidad del servicio' },
  { value: 'CANCELLATION',  label: 'Cancelación injustificada' },
  { value: 'ARTIST_NO_SHOW',label: 'El artista no se presentó' },
  { value: 'PRICING',       label: 'Problema con el precio' },
...
export function ReportarQuejaModal({ bookingId, reportedAgainst, artistName, onClose, onSuccess }: Props) {
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {artistName && <p className="text-xs text-gray-400">Sobre reserva con {artistName}</p>}
            </div>
          </div>
